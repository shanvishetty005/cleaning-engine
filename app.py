...
from cleaning_engine.service import run_cleaning_job, DEFAULT_CONFIG
...
st.sidebar.divider()
st.sidebar.caption("Tip: Use default settings for standard cleaning flow.")
